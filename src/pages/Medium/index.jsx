...
import { questions } from "../../questions/medium";
  ...
  return (
    <main className="flex justify-center pt-32 h-screen font-sans text-3xl text-white bg-gradient-to-l from-teal-600 to-cyan-600 sm:pt-24">
      <div className="flex flex-col items-center gap-28 sm:gap-20">
        <h1 className="font-bold">Dificuldade Médio</h1>
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-4 w-[440px] font-normal text-xl sm:gap-2">
          {questions[currentIndex].options.map((option, index) => (
            <button
              ...
              className="p-3 w-52 rounded-xl bg-slate-900 hover:bg-slate-950 hover:duration-200 disabled:cursor-no-drop disabled:opacity-80 sm:w-48"
            >
          ...
          <input
            ...
            className="p-3 w-52 rounded-xl cursor-pointer bg-slate-900 hover:bg-slate-950 hover:duration-200 disabled:cursor-no-drop disabled:opacity-80 sm:w-48"
          />
